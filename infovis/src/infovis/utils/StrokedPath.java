...
/**
 * Geometry methods on stroked paths.
 * 
...
public abstract class StrokedPath implements PathIterator {
    ...
    /**
     * Returns a point inside the specified box.
     * @param s the shape
     * @param hitbox the box
     * @param retPt the returned point
     * @return a point inside the specified box
     */
    ...
    /**
     * Returns true if there is a point inside the box
     * in the specified path segment.
     * 
     * @param coords the parameters of the path segment
     * @param type the type of the path segment
     * @param hitbox the box
     * @param retPt the return point
     * @return true if there is a point inside the box
     */
